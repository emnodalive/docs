...
<Accordion title="Sample request and response (Non-3DS)" icon="fa-code">
  ### Sample request
...
<Accordion title="Sample request and response (Non-3DS with cardId)" icon="fa-code">
  ### Sample request
...
<Accordion title="Sample request and response (3DS)" icon="fa-code">
  ### Sample request
